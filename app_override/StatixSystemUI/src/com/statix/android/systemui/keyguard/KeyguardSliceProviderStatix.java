...
public class KeyguardSliceProviderStatix extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    public Slice onBindSlice(Uri uri) {
        ...
        ListBuilder listBuilder = new ListBuilder(getContext(), ((KeyguardSliceProvider) this).mSliceUri, -1);
        synchronized (this) {
            ...
            if (z) {
                ...
                ListBuilder.HeaderBuilder title = new ListBuilder.HeaderBuilder(((KeyguardSliceProvider) this).mHeaderUri).setTitle(currentCard.getFormattedTitle());
                if (sliceAction != null) {
                ...
                if (needsMediaLocked()) {
                    ...
                    listBuilder.addRow(new ListBuilder.RowBuilder(((KeyguardSliceProvider) this).mDateUri).setTitle(getFormattedDateLocked()));
                }
