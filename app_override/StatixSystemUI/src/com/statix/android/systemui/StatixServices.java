...
public class StatixServices extends VendorServices {
    ...
    @Inject
    public StatixServices(Context context, UiEventLogger uiEventLogger, Lazy<ServiceConfigurationGoogle> serviceConfigurationGoogle, Lazy<ColumbusServiceWrapper> columbusService) {
        super(context);
