...
.PHONY: kernelpackage
kernelpackage: $(BUILT_TARGET_KERNEL_FILES_PACKAGE) $(IMG_FROM_TARGET_FILES)
	$(call pretty,"Package: $@")
	...
	@echo " "
	@echo " "
	@echo "Package Complete: $(STATIX_KERNEL_UPDATEPACKAGE)" >&2
	@echo "Package size: `du -h $(STATIX_KERNEL_UPDATEPACKAGE) | cut -f 1`"
