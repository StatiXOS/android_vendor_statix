...
$(PATH_OVERRIDE) make $(KERNEL_MAKE_FLAGS) -C $(KERNEL_SRC) O=$(1) ARCH=$(KERNEL_ARCH) $(KERNEL_CROSS_COMPILE) $(KERNEL_CLANG_TRIPLE) $(KERNEL_CC) $(KERNEL_LD) $(2)
endef
...
$(KERNEL_CONFIG): $(KERNEL_DEFCONFIG_SRC) $(KERNEL_ADDITIONAL_CONFIG_OUT)
	...
	$(hide)	if [ ! -z "$(GKI_KERNEL)" ]; then \
			$(PATH_OVERRIDE) ARCH=$(KERNEL_ARCH) $(TARGET_KERNEL_SOURCE)/scripts/gki/generate_defconfig.sh $(KERNEL_DEFCONFIG); \
		fi
...
$(TARGET_PREBUILT_INT_KERNEL): $(KERNEL_CONFIG) $(DEPMOD) $(HOST_OUT_EXECUTABLES)/dtc
...
$(INSTALLED_DTBIMAGE_TARGET): $(HOST_OUT_EXECUTABLES)/dtc
