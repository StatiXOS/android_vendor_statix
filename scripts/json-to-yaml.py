...
def main():
    ...
    try:
        ...
        print(
            "Invalid dependency file syntax! Make sure you don't have any commas at the end of your last dependency."
        )
        return
    for dependency in dependencies:
        if "target_path" in dependency and "repository" in dependency:
            ...
            print(
                "Define target_path for dependency {}".format(dependency["repository"])
            )
            return
        elif "repository" not in dependency and "target_path" in dependency:
            print(
                "Define repository for dependency {}".format(dependency["target_path"])
            )
            return
        else:
            print(
                "Invalid format, missing repository and target_path for dependency {}".format(
