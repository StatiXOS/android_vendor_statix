...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	@rm -rf $(dir $@)
	@mkdir -p $(dir $@)
	$(hide) tar xfp vendor/statix/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	$(hide) IMAGEWIDTH=$(TARGET_SCREEN_WIDTH); \
	...
	cat vendor/statix/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
